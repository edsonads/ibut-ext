...
abstract class EXT_Template_Base {
    ...
    public function __construct() {
        ...
        $this->html = new EXT_Tag_Tag('HTML');
        $this->head = new EXT_Tag_Tag('HEAD');
        $this->body = new EXT_Tag_Tag('BODY');
    }
     ...
     * @param $href 
     */
    protected function addCss($url, $noHead=true) {
    ...
    protected function addScript($url, $noHead=true) {
        $script = new EXT_Tag_Tag("SCRIPT");
    ...
    public function show() {
        ...
        $this->head->add('a'); //adiciona os scripts internos.
